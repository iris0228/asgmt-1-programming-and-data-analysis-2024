...
class TestAssignmentOne(unittest.TestCase):
    ...
    def test_05_use_bool_function(self):
        ...
        self.assertTrue(asgmt.use_bool_function(-1))
    def test_06_use_int_function(self):
        ...
        self.assertEqual(asgmt.use_int_function(-0.01), 0)
    def test_07_calculate_bmi(self):
    ...
    def test_08_format_integer_with_dollar_sign_and_commas(self):
